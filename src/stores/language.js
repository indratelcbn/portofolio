...
const translations = {
  en: {
    ...
    about: {
      ...
      bio1: "Frontend Developer with experience building enterprise web applications using Vue.js, JavaScript, Quasar Framework, RESTful APIs, Docker, PostgreSQL, and ArcGIS Enterprise. Experienced in developing government digital services and full-stack web applications from design to deployment.",
      bio2: "Passionate about building scalable, maintainable, and user-focused software. Currently seeking remote Frontend Developer opportunities with international teams.",
  ...
  id: {
    ...
    about: {
      ...
      bio1: 'Frontend Developer dengan pengalaman membangun aplikasi web enterprise menggunakan Vue.js, JavaScript, Quasar Framework, RESTful API, Docker, PostgreSQL, dan ArcGIS Enterprise. Berpengalaman dalam pengembangan layanan digital pemerintah dan aplikasi web full-stack dari desain hingga deployment.',
      bio2: 'Bersemangat dalam membangun perangkat lunak yang skalabel, mudah dipelihara, dan berfokus pada pengguna. Saat ini mencari peluang Frontend Developer remote bersama tim internasional.',
